...
export default function AddIncomeModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 pt-4 pb-24 sm:pb-4 animate-in fade-in duration-200">
      <div className="bg-gradient-to-br from-white via-gray-50 to-green-50/30 dark:from-gray-800 dark:via-gray-800 dark:to-green-900/20 rounded-2xl max-w-md w-full max-h-[85vh] sm:max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom zoom-in duration-300">
